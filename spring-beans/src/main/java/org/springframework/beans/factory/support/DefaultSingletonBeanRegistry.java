...
public class DefaultSingletonBeanRegistry extends SimpleAliasRegistry implements SingletonBeanRegistry {
	...
	private final Map<String, Object> singletonObjects = new ConcurrentHashMap<String, Object>(256);  //缓存单例对象
	...
	private final Set<String> registeredSingletons = new LinkedHashSet<String>(256);  //缓存已经注册的BeanDefinition
	...
	public Object getSingleton(String beanName, ObjectFactory<?> singletonFactory) {
		...
		synchronized (this.singletonObjects) {
			...
			if (singletonObject == null) {
				...
				try {
					singletonObject = singletonFactory.getObject();  //调用singletonFactory去创建bean
					newSingleton = true;
				}
